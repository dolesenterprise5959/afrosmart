...
# Promote the build args to env vars so `next build` statically inlines the
# NEXT_PUBLIC_* values into the client bundle (ARG alone is not reliably visible
# to the build process across BuildKit/legacy builders).
